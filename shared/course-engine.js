...
const RD_COURSE = {
 "key": "g2",
 "backLabel": "English+ Companion Course · B2+/C1",
 "tipLabel": "Tip",
 "navStyle": "pills",
 "chips": {},
 "lessonArt": {
  "1": "<div style=\"display:flex;flex-direction:column;gap:14px;align-items:flex-end;font-family:'Archivo';font-weight:800\">\n        <div style=\"display:flex;gap:10px;align-items:center;flex-wrap:wrap;justify-content:flex-end\"><span style=\"padding:5px 12px;border-radius:9px;background:#F6EEDD;color:#5C2140;font-size:22px\">had left</span><span style=\"font-family:'JetBrains Mono';font-weight:500;font-size:11px;letter-spacing:.12em;opacity:.7\">FLASHBACK</span></div>\n          <div style=\"display:flex;gap:10px;align-items:center;flex-wrap:wrap;justify-content:flex-end\"><span style=\"padding:4px 12px;border-radius:999px;border:1.5px solid rgba(246,238,221,.7);font-size:22px\">was raining</span><span style=\"font-family:'JetBrains Mono';font-weight:500;font-size:11px;letter-spacing:.12em;opacity:.7\">BACKGROUND</span></div>\n          <div style=\"display:flex;gap:10px;align-items:center;flex-wrap:wrap;justify-content:flex-end\"><span style=\"padding:4px 12px;border-radius:999px;border:1.5px dashed rgba(246,238,221,.7);font-size:22px\">walked in</span><span style=\"font-family:'JetBrains Mono';font-weight:500;font-size:11px;letter-spacing:.12em;opacity:.7\">STORY SPINE</span></div>\n      </div>"
 }
};
